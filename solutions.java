...
//    finds the absolute diffrence for each value in an array with all of its siblings
//   example: [1,2,3,4,5,6];
//    the absolute diffrence for 1 is (2-1) + (3-1) + (4-1) + (5-1) + (6-1)
//    total would be: 15
//    for 2 it would be 11
...
//    finds an empty slot with the biggest distance between the closest taken seats
//    example: [1,0,0,0,1,0,0,1];
//    the empty seat(0) that has the biggest distance from a taken seat(1) is index 2 with a distance of 2.
...
//    885. Spiral Matrix III
    ...
    public boolean validPath_(int n, int[][] edges, int source, int destination) {
        boolean[] visited = new boolean[n];
        visited[source] = true;
        for (int i = 0; i < n; i++){
